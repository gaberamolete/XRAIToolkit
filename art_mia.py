...
def mia_viz(precision,recall):
    ...
    green = {'type': "rect", 'x0': 0.5, 'y0': -0.5, 'x1': 1, 'y1': 0.5, 'line': {'width': 0}, 'fillcolor': '#008000', 'layer': 'below', 'opacity': 0.1}
    red = {'type': "rect", 'x0': 0, 'y0': -0.5, 'x1': 0.5, 'y1': 0.5, 'line': {'width': 0}, 'fillcolor': '#ff0000', 'layer': 'below', 'opacity': 0.1}
